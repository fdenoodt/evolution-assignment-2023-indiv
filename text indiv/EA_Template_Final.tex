...
\end{enumerate}
	...
	\textcolor{red}{
		We have made a slight change to the structure of the report. Section \ref{cha:final_design} remains the final design of the algorithm. Here we only discuss the genetic algorithm, which is based on the group project. A new section is added where we discuss the PL-GS algorithm. The performance of the algorithm is underwhelming and, therefore, not part of the final algorithm used for the performance evaluation of this course.
	}
